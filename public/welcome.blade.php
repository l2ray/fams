    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item active">
                <a class="nav-link" href="#">Asset List <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Asset Movement</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Depreciated Assets</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Valuable Assets</a>
            </li>
